/* This function allows to open a pop-up window */
function newPage(url,titre,width,height) { 
	return window.open(url, titre, 'menubar=no,scrollbars=yes,width=' + width + ',height=' + height + ',dependent=yes,left=' + (screen.width-width)/2 + ',top=' + (screen.height-height)/2); 
}
...
// This function is a genericDU function to create form elements
