...
public class DTPartialViewContext extends PartialViewContextWrapper {

    private final PartialViewContext wrapped;

    private PartialResponseWriter writer;

    public DTPartialViewContext(PartialViewContext wrapped) {
    ...
    public PartialResponseWriter getPartialResponseWriter() {
        if (writer == null) {
            ...
            writer = new DTPartialResponseWriter(parentWriter);
        }
